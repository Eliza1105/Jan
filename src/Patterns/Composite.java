...
public class Composite {
    public static void main(String[] args) {
        ...
        Group group1 = new Group(15,20,Color.BLUE);
        group1.add(rect1);
        group1.add(rect2);

        Shape rect3 = new Rect(200,200,Color.BLUE);
        Shape rect4 = new Rect(250,300,Color.BLUE);
        Group group2 = new Group(30,40,Color.BLUE);
        group1.add(rect3);
        group1.add(rect4);

        Group group3 = new Group(25,35,Color.BLUE);
...
interface ShapeProcessor {
 ...
 class Shape implements ShapeProcessor {
    public int x;
    public int y;
    public Color color;
